...
from terminal import ANSI_BLUE, ANSI_CYAN, ANSI_GREEN, ANSI_YELLOW
...
def detect_project_type(markers: set_type[str], ext_counter: dict[str, int]) -> str:
...
def workspace_recommendations(project_type: str, markers: set_type[str], todo_count: int) -> list[str]:
